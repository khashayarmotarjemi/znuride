...
class RidesRepository extends AbstractRideRepository {
  var sampleRides = [
    ...
    RideEntity(LatLng(1, 1), RideTime(14, 20, 1),
        DriverEntity("Ali", "09991112222", DriverSex.FEMALE, "11b22")),
  ...
  Future<List<RideEntity>> rides() async {
    return Future.delayed(Duration(seconds: 2), () => sampleRides);
  }
}
